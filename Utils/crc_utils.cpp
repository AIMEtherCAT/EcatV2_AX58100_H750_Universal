...
namespace aim::algorithm::crc8
{
    uint8_t get_CRC8_check_sum(const unsigned char* pch_message, unsigned int dw_length, unsigned char ucCRC8)
    {
        while (dw_length--)
        {
            const unsigned char uc_index = ucCRC8 ^ (*pch_message++);
