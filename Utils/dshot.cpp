...
void write_dshot1(uint16_t motor1, uint16_t motor2, uint16_t motor3, uint16_t motor4) {
    ...
    HAL_DMA_Start_IT(DSHOT1_TIM->hdma[TIM_DMA_ID_CC1], (uint32_t) dshot1_motor1_dmabuffer,
                     (uint32_t) & DSHOT1_TIM->Instance->CCR1, DSHOT_DMA_BUFFER_SIZE);
    HAL_DMA_Start_IT(DSHOT1_TIM->hdma[TIM_DMA_ID_CC2], (uint32_t) dshot1_motor2_dmabuffer,
                     (uint32_t) & DSHOT1_TIM->Instance->CCR2, DSHOT_DMA_BUFFER_SIZE);
    HAL_DMA_Start_IT(DSHOT1_TIM->hdma[TIM_DMA_ID_CC3], (uint32_t) dshot1_motor3_dmabuffer,
                     (uint32_t) & DSHOT1_TIM->Instance->CCR3, DSHOT_DMA_BUFFER_SIZE);
    HAL_DMA_Start_IT(DSHOT1_TIM->hdma[TIM_DMA_ID_CC4], (uint32_t) dshot1_motor4_dmabuffer,
                     (uint32_t) & DSHOT1_TIM->Instance->CCR4, DSHOT_DMA_BUFFER_SIZE);
...
void write_dshot2(uint16_t motor1, uint16_t motor2, uint16_t motor3, uint16_t motor4) {
    ...
    HAL_DMA_Start_IT(DSHOT2_TIM->hdma[TIM_DMA_ID_CC1], (uint32_t) dshot2_motor1_dmabuffer,
                     (uint32_t) & DSHOT2_TIM->Instance->CCR1, DSHOT_DMA_BUFFER_SIZE);
    HAL_DMA_Start_IT(DSHOT2_TIM->hdma[TIM_DMA_ID_CC2], (uint32_t) dshot2_motor2_dmabuffer,
                     (uint32_t) & DSHOT2_TIM->Instance->CCR2, DSHOT_DMA_BUFFER_SIZE);
    HAL_DMA_Start_IT(DSHOT2_TIM->hdma[TIM_DMA_ID_CC3], (uint32_t) dshot2_motor3_dmabuffer,
                     (uint32_t) & DSHOT2_TIM->Instance->CCR3, DSHOT_DMA_BUFFER_SIZE);
    HAL_DMA_Start_IT(DSHOT2_TIM->hdma[TIM_DMA_ID_CC4], (uint32_t) dshot2_motor4_dmabuffer,
                     (uint32_t) & DSHOT2_TIM->Instance->CCR4, DSHOT_DMA_BUFFER_SIZE);
